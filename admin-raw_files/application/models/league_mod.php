...
class League_mod extends CI_Model{
	...
	public function update_match($info){
		...
		//$sql = "UPDATE `schedule` SET `leagueid`='".$info['league']."',`season`='".$info['season']."',`week`='".$info['week']."',`hside`='".$info['home']."',`aside`='".$info['away']."',`date`='',`ldate`='".$info['local_date']."',`utc`='".$info['match_started']."',`second_half`='".$info['second_half_started']."',`htscore`='".$info['halftime_score']."',`ftscore`='".$info['fulltime_score']."',`status`='".$info['status']."' WHERE `matchid`='".$info['matchid']."'";
		...
		$sql = "UPDATE `schedule` SET `leagueid`='".$info['league']."',`season`='".$info['season']."',`week`='".$info['week']."',`hside`='".$info['home']."',`aside`='".$info['away']."',`date`='".$bangla_date."',`ldate`='".$ltime."',`utc`='".$utc."',`second_half`='".$shalf."',`htscore`='".$info['halftime_score']."',`media_link`='".$info['media_link']."',`ftscore`='".$info['fulltime_score']."',`status`='".$info['status']."' WHERE `matchid`='".$info['matchid']."'";
