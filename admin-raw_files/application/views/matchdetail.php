						...
						<div class="status-cont">
							...
							<div class="statusfrm hidden">
								...
								<select id="custom_time" class=" hidden" type="text" name="custom_time" value="" placeholder="Enter Time">
									...
									<?php 
									for($i = 1; $i < 6; $i++){
										?><option value="<?php echo $i; ?>"><?php echo $i.' Munites ago'; ?></option><?php 
									}
									?>
							...
							<form class="form-horizontal" action="" method="post">
							  ...
							  <div class="form-group">
								...
								<div class="col-lg-4">
									...
									<input type="text" name="player" id="player" placeholder="Player" class="validate[required] form-control" value="<?php if(!empty($maction[0]->player)) echo $maction[0]->player; ?>">
