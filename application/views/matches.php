						...
						if(!empty($action) && $action=='edit' && !empty($mdata)){
							...
							<form class="form-horizontal" action="" method="post">
							  ...
							  <div class="form-group">
								...
								<label class="control-label col-lg-4">Highlights</label>

								<div class="col-lg-4">
									<input name="highlights" type='text' class="form-control" value="<?php if(!empty($mdata[0]->highlights)){ echo $mdata[0]->highlights; } ?>" />
								</div>
